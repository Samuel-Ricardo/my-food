...
internal open class SpringCourierConfiguration {
    ...
    @Bean
    open fun courierCommandHandler(axonConfiguration: AxonConfiguration, eventBus: EventBus) =
        CourierCommandHandler(axonConfiguration.repository(Courier::class.java), eventBus)
    ...
    open fun courierSnapshotTriggerDefinition(snapshotter: Snapshotter) =
        EventCountSnapshotTriggerDefinition(snapshotter, snapshotTriggerTresholdCourier)


    open fun courierOrderSnapshotTriggerDefinition(snapshotter: Snapshotter) =
